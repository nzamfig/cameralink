...
import { sampleDegree, sampleIndices, splitIntoBlocks } from './lt-common.js';
...
export class LtEncoder {
   ...
   */
  constructor(blocks: Uint8Array[], totalBlocks: number) {
    this.blocks = blocks;
   ...
   */
  nextSymbol(seed: number): { payload: Uint8Array; indices: number[] } {
