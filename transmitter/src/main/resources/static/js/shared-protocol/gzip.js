 ...
 */
async function gzipCompressBrowser(data) {
 ...
 */
async function gzipDecompressBrowser(data) {
    const stream = new Blob([data]).stream();
 ...
 */
async function gzipCompressNode(data) {
 ...
 */
async function gzipDecompressNode(data) {
    const zlib = await import('node:zlib');
    const util = await import('node:util');
